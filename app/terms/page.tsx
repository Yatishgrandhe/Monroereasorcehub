        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto border border-[var(--color-border)] bg-[var(--color-surface)] rounded-2xl p-8 md:p-12 shadow-soft">
            <div className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:text-[var(--color-primary)] prose-p:text-[var(--color-text-muted)] prose-a:text-[var(--color-primary)] hover:prose-a:text-primary-700">
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">1. Acceptance of Terms</h2>
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">2. Description of Service</h2>
              <p className="text-[var(--color-text-muted)] leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">3. Use of the Hub</h2>
              <p className="text-[var(--color-text-muted)] leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">4. Resource Submissions</h2>
              <p className="text-[var(--color-text-muted)] leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">5. Account & Career Tools</h2>
              <p className="text-[var(--color-text-muted)] leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">6. Accuracy of Information</h2>
              <p className="text-[var(--color-text-muted)] leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">7. Intellectual Property</h2>
              <p className="text-[var(--color-text-muted)] leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">8. Disclaimer</h2>
              <p className="text-[var(--color-text-muted)] leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">9. Limitation of Liability</h2>
              <p className="text-[var(--color-text-muted)] leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] mb-6">10. Changes</h2>
