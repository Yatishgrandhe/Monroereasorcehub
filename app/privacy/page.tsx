        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto border border-[var(--color-border)] dark:border-white/10 bg-[var(--color-surface)] dark:bg-[#1e293b] rounded-2xl p-8 md:p-12 shadow-soft">
            <div className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:text-[var(--color-primary)] dark:prose-headings:text-white prose-p:text-[var(--color-text-muted)] dark:prose-p:text-gray-300 prose-a:text-[var(--color-primary)] hover:prose-a:text-primary-700 dark:prose-a:text-accent-400">
              <h2 className="text-2xl font-black text-[var(--color-text)] dark:text-white mb-6">1. Information We Collect</h2>
              ...
              <ul className="list-disc pl-6 space-y-2 text-[var(--color-text-muted)] dark:text-gray-300 mb-8">
                <li><strong className="text-[var(--color-text)] dark:text-white">Account data:</strong> If you create an account (email, password, name, optional profile info) for career tools, resume builder, or saved jobs.</li>
                <li><strong className="text-[var(--color-text)] dark:text-white">Resource submissions:</strong> Information you submit when adding a community resource (organization name, address, contact details, hours).</li>
                <li><strong className="text-[var(--color-text)] dark:text-white">Usage data:</strong> Basic analytics (pages visited, features used) to improve the site. No personal data is sold.</li>
              </ul>

              <h2 className="text-2xl font-black text-[var(--color-text)] dark:text-white mb-6">2. How We Use Your Information</h2>
              <p className="text-[var(--color-text-muted)] dark:text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] dark:text-white mb-6">3. Data Sharing</h2>
              <p className="text-[var(--color-text-muted)] dark:text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] dark:text-white mb-6">4. Cookies & Storage</h2>
              <p className="text-[var(--color-text-muted)] dark:text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] dark:text-white mb-6">5. Data Security</h2>
              <p className="text-[var(--color-text-muted)] dark:text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] dark:text-white mb-6">6. Your Rights</h2>
              <p className="text-[var(--color-text-muted)] dark:text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] dark:text-white mb-6">7. Children</h2>
              <p className="text-[var(--color-text-muted)] dark:text-gray-300 leading-relaxed mb-6">
              ...
              <h2 className="text-2xl font-black text-[var(--color-text)] dark:text-white mb-6">8. Changes</h2>
