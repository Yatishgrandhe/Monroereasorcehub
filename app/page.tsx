    ...
    <div className="min-h-screen bg-[#020617]">
      ...
      <section className="section-padding relative overflow-hidden bg-[#020617]">
        ...
        <div className="container-custom relative z-10 text-center">
          <Reveal width="100%">
            <div className="max-w-5xl mx-auto p-10 md:p-24 rounded-[4rem] bg-white/[0.02] border border-white/10 backdrop-blur-3xl transition-all duration-700 hover:border-primary-500/30 hover:bg-white/[0.03] shadow-[0_64px_128px_-32px_rgba(0,0,0,0.5)]">
              <Badge variant="glass" className="mb-10 bg-white/5 text-white border-none font-black tracking-[0.4em] uppercase text-[10px] px-8 py-2.5">
                Join the Network
              </Badge>
              <h2 className="mb-8 text-white text-5xl md:text-8xl font-black tracking-tighter leading-none">
                Ready to find <br /><span className="text-gradient-logo">what you need?</span>
              </h2>
              <p className="text-xl md:text-2xl mb-14 text-slate-400 max-w-2xl mx-auto font-medium leading-relaxed italic">
                Join thousands of Monroe residents finding help and opportunity every single day.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Magnetic strength={0.3}>
                  <Button size="lg" variant="gradient" className="w-full sm:w-auto px-12 h-16 rounded-3xl bg-primary-600 hover:bg-primary-500 border-none shadow-2xl shadow-primary-500/30 text-xs font-black uppercase tracking-widest text-white" asChild href="/resources">
                    <Link href="/resources">Get Started</Link>
                  </Button>
                </Magnetic>
                <Magnetic strength={0.2}>
                  <Button size="lg" variant="outline" className="w-full sm:w-auto px-12 h-16 rounded-3xl border-white/10 text-white hover:bg-white/5 font-black text-xs uppercase tracking-widest" asChild href="/career/resume-builder">
