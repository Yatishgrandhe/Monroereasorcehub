  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <Reveal width="100%">
            <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-16 gap-8 text-center md:text-left">
              <div className="max-w-2xl">
                <span className="text-secondary-500 font-bold uppercase tracking-widest text-xs font-sans">Featured</span>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-primary-950 mt-4 mb-6 leading-tight">
                  Featured community partners<span className="text-secondary-500">.</span>
                </h2>
              ...
              <Button className="mt-4 md:mt-0 shrink-0 bg-primary-500 text-white hover:bg-primary-600 shadow-[0_4px_24px_#3461ad73]" asChild>
                <Link href="/resources">
      ...
      <section className="cta-section py-12 px-6 lg:px-12 pb-24 bg-white relative">
        <div className="container-custom mx-auto bg-civic-gradient rounded-b-[4rem] rounded-t-[3.5rem] relative overflow-hidden py-32 px-10 md:px-20 text-center shadow-[0_32px_128px_-16px_#3461ad4d] max-w-[860px]">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <Reveal width="100%">
              <span className="text-accent-400 font-bold uppercase tracking-[0.2em] text-xs mb-4 block font-sans">GET STARTED</span>
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-8 leading-tight tracking-tighter">
                Find help in Monroe, today<span className="text-secondary-500">.</span>
              </h2>
              <p className="text-lg md:text-xl mb-16 text-slate-300 leading-relaxed max-w-[520px] mx-auto font-sans">
