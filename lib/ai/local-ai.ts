...
export function shouldUseLocalAI(): boolean {
  // Return true if you want to force 200MB local model download.
  // Return false to use the Vercel-hosted Cloud AI (Gemini/Server Actions) which is instant and requires 0 downloads.
  return false;
}
