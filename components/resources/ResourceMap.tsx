        ...
        const initMap = async () => {
            ...
            try {
                ...
                <div class="flex flex-col gap-2 min-w-[200px]">
                  <span class="text-[10px] font-black uppercase tracking-[0.2em] text-primary-400">${category}</span>
                  <h3 class="text-lg font-black text-white m-0 leading-tight">${name}</h3>
                  <p class="text-[13px] text-slate-400 leading-relaxed mt-1 mb-2">${description}</p>
              ...
              `);
                    ...
                    pointToLayer: (feature, latlng) => {
                        // Use a custom pulse-like CircleMarker for a bespoke feel
